...
aggregated as (
    ...
    select
        ...
        {{ tiktok_ads_persist_pass_through_columns(pass_through_variable='tiktok_ads__campaign_country_report_passthrough_metrics', identifier='hourly', transform='sum', coalesce_with=0) }}        
