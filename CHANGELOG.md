# dbt_tiktok_ads v0.4.1
[PR #8](https://github.com/fivetran/dbt_tiktok_ads/pull/8) includes the following changes:
## 🎉 Features 🎉
- Added ability for a user to allow records having nulls in url fields to be included in the `tiktok_ads__url_report` model. This is done by setting one of the variables below to `True` in your `dbt_project.yml` file. 
...
## 🚘 Under the Hood 🚘
- Disabled the `not_null` test for `tiktok_ads__url_report` when null urls are allowed.
