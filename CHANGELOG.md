...
- Removed the dependency on the `fivetran/tiktok_ads_source` package.
  ...
  - Update any tiktok_ads_source-scoped variables to be scoped to only under this package. See the [README](https://github.com/fivetran/dbt_tiktok_ads/blob/main/README.md) for how to configure the build schema of staging models.
