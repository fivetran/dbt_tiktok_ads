...
[PR #TBD](https://github.com/fivetran/dbt_tiktok_ads/pull/TBD) includes the following updates:
...
| ---------- | ----------- | -------- | -------- | ----- |
| `stg_tiktok_ads__smart_plus_ad_history_tmp` | New Tmp Model | | | |
| `stg_tiktok_ads__smart_plus_ad_history` | New Staging Model | | | |
